    ...
    <header id="header">
		...
		<div id="head_link">
			...
			<ul>
				...
				<li class="head_newsletter"><a href="http://eepurl.com/IiiHD?utm_source=Getchee+Blog&amp;utm_medium=Subscribe+Banner&amp;utm_content=FindTheBestMalls&amp;utm_campaign=getchee8+Presentation" target="_blank">Newsletter Signup</a></li>

				<li class="head_email"><a href="mailto:curious@getchee.com" target="_blank">Email</a></li>

				<li class="head_search"><?php get_search_form(); ?></li>

				<li class="head_social_media">
					<ul class="head-social-network">
	                  <li><a href="http://twitter.com/getchee" target="_blank" title="Twitter"><img src="<?php echo IMAGES . '/icon-twitter.png'; ?>" alt="Tweet This" title="Tweet this"/></a></li>
	                  <li><a href="http://www.linkedin.com/company/getchee" target="_blank" title="LinkedIn"><img src="<?php echo IMAGES . '/icon-linkedin.png'; ?>" title="Share on LinkedIn" alt="Share on LinkedIn"/></a></li>
	                  <li><a href="http://www.facebook.com/teamgetchee" target="_blank" title="Facebook"><img src="<?php echo IMAGES . '/icon-facebook.png'; ?>" alt="Share on Facebook"/></a></li>
	                  <li><a href="http://www.weibo.com/getchee" target="_blank" title="Weibo"><img src="<?php echo IMAGES . '/icon-weibo.png'; ?>" alt="Tweet This" title="Share on Weibo"/></a></li>
	                </ul>
				</li>
		...
		<div class="wrapper">
			...
			<hgroup>
				...
				<h1>New Market Insight</h1>

				<h2>The web's best blog for data based retail and banking strategy</h2>
