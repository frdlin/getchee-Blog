 ...
 */
function framework_hook_comments( $callback = array('framework_comment_author_meta', 'framework_comment_moderation', 'framework_comment_text', 'framework_comment_reply' ) ) {
