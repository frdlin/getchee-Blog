 ...
 * @todo needs filter
 */
function framework_comment_author_meta( $meta_format = '%name% %date% %time% | %link% %edit%' ) {
	$meta_format = apply_filters( 'framework_comment_author_meta_meta_format', $meta_format ); // Available filter: framework_comment_author_meta_format
	if ( ! $meta_format ) return;
